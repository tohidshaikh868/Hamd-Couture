...
import { products, arabianCategories } from '../data';
import ProductCard from '../components/ProductCard';

export default function ArabianFashion() {
  const arabianProducts = products.filter(p => p.category === 'Arabian Fashion');
  ...
  return (
    <div className="pt-24 min-h-screen bg-white pb-24">
      ...
      <div className="relative h-[40vh] md:h-[50vh] overflow-hidden mb-16">
        <img 
          src="https://images.unsplash.com/photo-1595777457583-95e059d581b8?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80" 
          alt="Arabian Fashion" 
        ...
        <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center text-center px-4">
          ...
          >
            Discover our curated collection of Premium Abayas, Designer Kaftans, and Luxury Modest Wear.
          </motion.p>
        </div>
      </div>
